...
public class StrMatchTest {
	 ...
	 */
	/*
	 * @Test public void testBruteForce() throws Exception { StrMatch s = new
	 * StrMatch(); LookBackStringBuffer lbsb = newLookBackStringBuffer(
	 * "hello world my name is ryan, and i can shoot 3s like no others.");
